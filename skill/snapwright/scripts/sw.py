...
def main(argv=None):
    ...
    if a.cmd == "preview":
        ...
        m = pipeline.build(a.design, a.out, seeds=a.seeds, finish=a.finish, audience=a.audience,
                           max_per_step=a.max_per_step, book=not a.no_book, viewer=not a.no_viewer,
                           page=a.page, strict=not a.no_strict)
